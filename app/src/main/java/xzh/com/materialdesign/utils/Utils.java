...
public class Utils {
	...
	private Utils(Context context){
		...
		mList.add(new NavigationItem("我的订单", context.getResources().getDrawable(R.drawable.ic_drawer_explore_normal),Style.DEFAULT));
		mList.add(new NavigationItem("接收订单", context.getResources().getDrawable(R.drawable.ic_drawer_follow_normal),Style.DEFAULT));
